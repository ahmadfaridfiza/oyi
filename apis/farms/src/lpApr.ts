...
const STABLESWAP_SUBGRAPH_ENDPOINT = 'https://api.studio.thegraph.com/query/1749771/plaxman/version/latest'
...
const INFO_CLIENT_WITH_CHAIN = {
  [ChainId.BSC]: 'https://api.studio.thegraph.com/query/1749771/plaxman/version/latest',
  [ChainId.BSC_TESTNET]: '',
  [ChainId.ETHEREUM]: '',
  [ChainId.GOERLI]: '',
}
